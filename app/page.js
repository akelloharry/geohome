...
const overlayStyles = 'pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(44,110,92,0.78)_0%,rgba(95,138,123,0.62)_45%,rgba(30,58,77,0.72)_100%)]'
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-deep-maritime text-white">
      ...
      <div className="absolute inset-0 z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col justify-between px-4 py-4 sm:px-6 sm:py-6 lg:px-10">
        <header className="mx-auto flex w-full max-w-6xl flex-col gap-6 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="text-sm font-semibold uppercase tracking-[0.3em] text-official-teal">GeoHome Kenya</div>
            <div className="mt-3 flex flex-wrap items-center gap-2 text-3xl font-heading font-black text-deep-maritime sm:text-4xl">
              <span>Geo</span>
              <span className="text-geohome-gold">Home</span>
              <span>Kenya</span>
            </div>
          </div>
          <nav className="flex flex-wrap items-center gap-4 text-sm text-anchor-gray">
            <Link href="#about" className="hover:text-official-teal">About</Link>
            <Link href="#contact" className="hover:text-official-teal">Contact</Link>
            <Link href="#privacy" className="hover:text-official-teal">Privacy</Link>
          </nav>
        </header>

        <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 py-10 text-left sm:py-16">
          <div className="max-w-3xl">
            <span className="inline-flex rounded-full bg-mint-hint px-4 py-2 text-xs font-semibold uppercase tracking-[0.32em] text-official-teal backdrop-blur-xl">
              GeoHome Verified rentals in Kisumu
            </span>
            <h1 className="mt-6 text-4xl font-heading font-black leading-tight tracking-tight text-deep-maritime sm:text-5xl md:text-6xl">
              Find your home in Kenya — as simple as dropping a pin.
            </h1>
            <p className="mt-5 max-w-2xl text-base text-anchor-gray sm:text-lg">
              Explore verified and available homes in Kisumu with live map pins, city-wide rental stats, and a polished experience built for tenants.
            </p>
          </div>
          ...
          <div className="grid gap-6 xl:grid-cols-[1.35fr_0.75fr]">
            <div className="rounded-[32px] border border-cloud-white/15 bg-cloud-white/10 p-6 shadow-2xl shadow-slate-950/30 backdrop-blur-xl sm:p-8">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-3xl border border-pale-steel bg-cloud-white p-6">
                  <div className="text-sm font-semibold uppercase tracking-[0.24em] text-anchor-gray">County coverage</div>
                  <div className="mt-4 text-4xl font-heading font-black text-official-teal">{loadingStats ? '...' : stats.counties}</div>
                ...
                <div className="rounded-3xl border border-pale-steel bg-cloud-white p-6">
                  ...
                  <div className="mt-4 text-4xl font-heading font-black text-trust-teal">{loadingStats ? '...' : stats.activeListings}</div>
                  <p className="mt-2 text-sm text-anchor-gray">Verified homes currently available</p>
                </div>
              </div>

              <div className="mt-8 rounded-3xl border border-pale-steel bg-cloud-white p-6">
            ...
            <div className="space-y-6">
              <div className="rounded-[32px] border border-pale-steel bg-white p-6 shadow-xl shadow-slate-900/10 sm:p-8">
                <div className="text-sm font-semibold uppercase tracking-[0.24em] text-official-teal">Tenant-first tools</div>
                <h2 className="mt-4 text-3xl font-heading font-black text-deep-maritime">Full-screen map, instant listings, trusted homes.</h2>
              ...
              <div className="rounded-[32px] border border-pale-steel bg-cloud-white p-6 shadow-xl shadow-slate-900/10 sm:p-8">
                <div className="text-sm font-semibold uppercase tracking-[0.24em] text-official-teal">Ready to explore</div>
                <p className="mt-4 text-sm text-anchor-gray">Tap the map pins or follow the button below to see every Kisumu listing in a full-screen discovery experience.</p>
        ...
        <footer className="mx-auto flex w-full max-w-6xl flex-col gap-4 border-t border-pale-steel pt-6 text-sm text-anchor-gray sm:flex-row sm:items-center sm:justify-between">
