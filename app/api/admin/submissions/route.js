...
export async function PATCH(req) {
  ...
  if (status === 'approved') {
    ...
    const propertyPayload = {
      ...
      water_supply: submission.water_supply ? [submission.water_supply] : [],
      electricity: submission.electricity ? [submission.electricity] : [],
      parking: submission.parking ? [submission.parking] : [],
      security: submission.security || [],
      backup_power: submission.backup_power ? [submission.backup_power] : [],
      internet: submission.internet ? [submission.internet] : [],
      lat: submission.lat,
      lng: submission.lng,
